...
@Component({
  selector: 'app-posqr-data',
  templateUrl: './posqr-data.component.html',
  styleUrls: ['./posqr-data.component.scss']
})
export class PosqrDataComponent implements OnInit {
  ...
  updatePosQrMerchantStatus(id: number, status: ServiceStatus,) {
